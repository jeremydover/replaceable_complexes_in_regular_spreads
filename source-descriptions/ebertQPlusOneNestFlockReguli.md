# (q+1)-nest construction with disjoint reguli from flock
...
ebertQPlusOneNestFlockReguliImplementation(q,c,reguli);
...
If successful, a replaceable complex containing a (q+1)-nest and a set of flock reguli disjoint from it.